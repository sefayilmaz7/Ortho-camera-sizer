...
public class CameraSizer : MonoBehaviour
{
    ...
    [SerializeField] private Camera[] CMS;
    ...
    void LateUpdate()
    {
        ...
        {
            CMS[i].orthographicSize = CalculateOrthographicSize(boundingBox);
        }
    ...
    Rect CalculateTargetsBoundingBox()
    {
        ...
        return Rect.MinMaxRect(minX - boundingBoxPadding, maxY + boundingBoxPadding, maxX + boundingBoxPadding,
    ...
    float CalculateOrthographicSize(Rect boundingBox)
    {
        ...
        return Mathf.Clamp(Mathf.Lerp(camera.orthographicSize, orthographicSize, Time.deltaTime * zoomSpeed),
            minimumOrthographicSize, Mathf.Infinity);
    }
}